module.exports = (url,content, func, name) => `
<!DOCTYPE HTML
                          ...
                          <tr>
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><strong>M O L A&nbsp; &nbsp;S H O
                                    P&nbsp; &nbsp;N O T I&nbsp; &nbsp;!</strong></p>
                              </div>
                            </td>
                          </tr>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              align="left">
                              <div
                                style="color: #e5eaf5; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; "><span
                                    style="font-size: 28px; line-height: 39.2px;"><strong><span
                                        style="line-height: 39.2px; font-size: 28px;">${func}
                                      </span></strong>
                                  </span>
                                </p>
                              </div>
                          ...
                          <tr>
                            <td
                              ...
                              <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 160%;"><span
                                    style="font-size: 18px; line-height: 28.8px;">${content}</span><br>
                                    <span style="font-size: 18px; line-height: 28.8px;"> Email xác thực sẽ hết hạn trong vòng 5 phút
                                    </span>
                                    </p>
                              </div>
                            </td>
                                ...
                                <a href="${url}" target="_blank" class="v-button"
                                  ...
                                  <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span
                                      style="font-size: 16px; line-height: 19.2px;"><strong><span
                                          style="line-height: 19.2px; font-size: 16px;">${func}</span></strong>
                                    </span>
                                  </span>
                                </a>
                          ...
                          <tr>
                            <td
                              ...
                              <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                ...
                                <p style="line-height: 160%; font-size: 14px;"><span
                                    style="font-size: 18px; line-height: 28.8px;">Mola</span></p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
                            ...
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 160%;"><span
                                    ...
                                    4444</span></p>
                                <p style="font-size: 14px; line-height: 160%;"><span
                                    style="font-size: 16px; line-height: 25.6px; color: #000000;">Mola.com</span>
                                </p>
                              </div>
                            </td>
                          </tr>
                            ...
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 180%;"><span
                                    style="font-size: 16px; line-height: 28.8px;">Copyrights &copy; by QT</span></p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
